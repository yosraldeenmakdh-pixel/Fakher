        ...
        return $table
            ->columns([
                ...
                TextColumn::make('meal.name')
                    ...
                    ->color('warning')
                    ->description(fn ($record) => $record->meal->kitchen->name ?? ''),
                    ...
                    Action::make('toggleVisibility')
                        ...
                        ->modalDescription(function ($record) {
                            return $record->is_visible
                                ? 'هل تريد إخفاء هذا التقييم من الموقع'
                                : 'هل تريد إظهار هذا التقييم في الموقع';
                        })
                        ->modalSubmitActionLabel('نعم')
                        ->modalCancelActionLabel('إلغاء'),

                    // Action::make('viewMeal')
                    //     ->label('عرض الوجبة')
                    //     ->icon('heroicon-o-arrow-top-right-on-square')
                    //     ->color('success')
                    //     ->url(fn ($record) => MealResource::getUrl('view', ['record' => $record->meal_id]))
                    //     ->openUrlInNewTab()
                    //     ->visible(fn () => class_exists(MealResource::class)),
                ])
                ->label('الإجراءات')
